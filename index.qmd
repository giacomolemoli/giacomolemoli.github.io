...
description: "Postdoctoral Researcher at Franklin University Switzerland"
page-layout: full
---

<!-- NOTE: Copy content/authors/admin/avatar.jpg from the starter-hugo-academic repo
     into assets/avatar.jpg before rendering. -->

::: {.profile-section}

::: {.profile-left}
![Giacomo Lemoli](assets/avatar.jpg){.avatar}
...
- <i class="fa-solid fa-graduation-cap"></i> PhD in Politics, 2023 — New York University
- <i class="fa-solid fa-graduation-cap"></i> MSc Economic and Social Sciences, 2017 — Bocconi University
- <i class="fa-solid fa-graduation-cap"></i> BSc International Economics, Management and Finance, 2014 — Bocconi University
:::
:::
